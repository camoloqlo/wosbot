...
public abstract class DelayedTask implements Runnable, Delayed {
    ...
    /**
     * @deprecated Use
     *             {@link NavigationHelper#ensureCorrectScreenLocation(EnumStartLocation)}
     *             instead.
     *             This method will be removed in a future version.
     */
    @Deprecated
    protected void ensureCorrectScreenLocation(EnumStartLocation requiredLocation) {
        navigationHelper.ensureCorrectScreenLocation(requiredLocation);
    }

    /**
     * @deprecated Use {@link IntelScreenHelper#ensureOnIntelScreen()} instead.
     *             This method will be removed in a future version.
     */
    @Deprecated
    ...
    /**
     * @deprecated Use {@link StaminaHelper#staminaRegenerationTime(int, int)}
     *             instead.
     *             This method will be removed in a future version.
     */
    @Deprecated
    protected int staminaRegenerationTime(int currentStamina, int targetStamina) {
        return staminaHelper.staminaRegenerationTime(currentStamina, targetStamina);
    }

    /**
     * @deprecated Use {@link StaminaHelper#updateStaminaFromProfile()} instead.
     *             This method will be removed in a future version.
     */
    @Deprecated
    ...
    /**
     * @deprecated Use {@link StaminaHelper#getSpentStamina()} instead.
     *             This method will be removed in a future version.
     */
    @Deprecated
    protected Integer getSpentStamina() {
        return staminaHelper.getSpentStamina();
    }

    /**
     * @deprecated Use {@link StaminaHelper#subtractStamina(Integer, boolean)}
     *             instead.
     *             This method will be removed in a future version.
     */
    @Deprecated
    ...
    /**
     * @deprecated Use {@link StaminaHelper#addStamina(Integer)} instead.
     *             This method will be removed in a future version.
     */
    @Deprecated
    protected void addStamina(Integer stamina) {
        staminaHelper.addStamina(stamina);
    }

    /**
     * @deprecated Use {@link StaminaHelper#parseTravelTime()} instead.
     *             This method will be removed in a future version.
     */
    @Deprecated
    protected long parseTravelTime() {
        return staminaHelper.parseTravelTime();
    }

    /**
     * @deprecated Use {@link StaminaHelper#getCurrentStamina()} instead.
     *             This method will be removed in a future version.
     */
    @Deprecated
    protected int getCurrentStamina() {
        return staminaHelper.getCurrentStamina();
    }

    /**
     * @deprecated Use
     *             {@link StaminaHelper#checkStaminaAndMarchesOrReschedule(int, int, StaminaHelper.RescheduleCallback)}
     *             instead.
     *             This method will be removed in a future version.
     */
    @Deprecated
    protected boolean checkStaminaAndMarchesOrReschedule(int minStaminaLevel, int refreshStaminaLevel) {
        return staminaHelper.checkStaminaAndMarchesOrReschedule(
                minStaminaLevel,
                refreshStaminaLevel,
                this::reschedule);
    }
    ...
    /**
     * @deprecated Use {@link MarchHelper#selectFlag(Integer)} instead.
     *             This method will be removed in a future version.
     */
    @Deprecated
    ...
    /**
     * @deprecated Use {@link MarchHelper#checkMarchesAvailable()} instead.
     *             This method will be removed in a future version.
     */
    @Deprecated
    protected boolean checkMarchesAvailable() {
        return marchHelper.checkMarchesAvailable();
    }

    /**
     * @deprecated Use {@link MarchHelper#openLeftMenuCitySection(boolean)} instead.
     *             This method will be removed in a future version.
     */
    @Deprecated
    ...
    /**
     * @deprecated Use {@link MarchHelper#closeLeftMenu()} instead.
     *             This method will be removed in a future version.
     */
    @Deprecated
    ...
    /**
     * @deprecated Use {@link AllianceHelper#disableAutoJoin()} instead.
     *             This method will be removed in a future version.
     */
    @Deprecated
    protected boolean disableAutoJoin() {
        return allianceHelper.disableAutoJoin();
    }

    /**
     * @deprecated Use {@link EventHelper#isBearRunning()} instead.
     *             This method will be removed in a future version.
     */
    @Deprecated
    public boolean isBearRunning() {
        return eventHelper.isBearRunning();
    }
